...
VALUES ('Michael Jackson', 'Thriller', '1982-01-01', 46, 'Pop, rock, R&B'),

('AC/DC', 'Back in Black', '1980-01-01', 26.1, 'Hard rock'),

('Pink Floyd', 'The Dark Side of the Moon', '1973-01-01', 24.2, 'Progressive rock'),

('Whitney Houston / Various artists', 'The Bodyguard', '1992-01-01', 27.4, 'Soundtrack/R&B, soul, pop'),
...
('Bee Gees / Various artists', 'Saturday Night Fever', '1977-01-01', 20.6, 'Disco'),

('Fleetwood Mac', 'Rumours', '1977-01-01', 27.9, 'Soft rock'),

('Shania Twain', 'Come On Over', '1997-01-01', 29.6, 'Country, pop'),

('Led Zeppelin', 'Led Zeppelin IV', '1971-01-01', 29, 'Hard rock, heavy metal'),
...
('The Beatles', 'Sgt. Peppers Lonely Hearts Club Band', '1967-01-01', 13.1, 'Rock'),

('Eagles', 'Hotel California', '1976-01-01', 21.5, 'Rock, soft rock, folk rock'),

('Mariah Carey', 'Music Box', '1993-01-01', 19, 'Pop, R&B, Rock'),

('Michael Jackson', 'Dangerous', '1991-01-01', 17.6, 'Rock, Funk, Pop'),

('Various artists', 'Dirty Dancing', '1987-01-01', 17.9, 'Pop, rock, R&B'),

('Celine Dion', 'Lets Talk About Love', '1997-01-01', 19.3, 'Pop, Soft rock'),
